window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					...
					children: [
						...
						report === null && state.state !== "error" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							...
							optimization !== void 0 && /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
								style: optimizationStyle,
								"aria-label": t("cd.optimization"),
								children: [
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("header", {
										style: optimizationHeadStyle,
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											style: optimizationTitleStyle,
											children: t("cd.optimization")
										}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											style: {
												...tierStyle,
												color: optimization.active ? TONE.mint : TONE.muted
											},
											children: optimization.active ? t("cd.tier", { tier: optimization.tier }) : t("cd.inactive")
										})]
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										style: optimizationStatsStyle,
										children: [
											/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
												style: optimizationStatStyle,
												children: [
													/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
														style: optimizationLabelStyle,
														children: t("cd.before")
													}),
													/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", {
														style: optimizationValueStyle,
														children: formatTokens(optimization.registeredSchemaTokens)
													}),
													/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("small", {
														style: optimizationSubStyle,
														children: [optimization.registeredTools, " tools"]
													})
												]
											}),
											/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												style: optimizationArrowStyle,
												"aria-hidden": "true",
												children: "→"
											}),
											/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
												...
												children: [
													...
													/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", {
														style: optimizationValueStyle,
														children: formatTokens(optimization.visibleSchemaTokens + optimization.manifestTokens)
													}),
													/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("small", {
														style: optimizationSubStyle,
														children: [
															optimization.visibleTools,
															" schemas + ",
															optimization.deferredTools,
															" deferred"
														]
													})
												]
											...
											/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
												...
												children: [
													/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
														style: optimizationLabelStyle,
														children: t("cd.savings")
													}),
													/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", {
														style: {
															...optimizationValueStyle,
															color: optimization.savedTokens > 0 ? TONE.mint : TONE.muted
														},
														children: formatTokens(optimization.savedTokens)
													}),
													/* @__PURE__ */ (0, react_jsx_runtime.jsx)("small", {
														style: optimizationSubStyle,
														children: optimization.registeredSchemaTokens === 0 ? "0%" : `${Math.round(optimization.savedTokens / optimization.registeredSchemaTokens * 100)}%`
													})
												]
											})
										]
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
										...
										"aria-label": `${t("cd.before")} ${formatTokens(optimization.registeredSchemaTokens)}, ${t("cd.after")} ${formatTokens(optimization.visibleSchemaTokens + optimization.manifestTokens)}`,
										children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { style: {
											...savingRailVisibleStyle,
											width: `${Math.min(100, optimization.registeredSchemaTokens === 0 ? 0 : (optimization.visibleSchemaTokens + optimization.manifestTokens) / optimization.registeredSchemaTokens * 100)}%`
										} })
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										style: warmStyle,
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											...
											style: warmValueStyle,
											title: optimization.warmTools.join(", "),
											children: optimization.warmTools.length === 0 ? t("cd.none") : optimization.warmTools.join(", ")
										})]
									})
								]
							}),
		...
		const optimizationStatsStyle = {
			display: "grid",
			gridTemplateColumns: "minmax(0, 1fr) 14px minmax(0, 1fr) minmax(0, .85fr)",
			alignItems: "end",
			gap: 7,
			marginTop: 10
		};
		const optimizationStatStyle = {
			display: "flex",
			minWidth: 0,
			flexDirection: "column",
			gap: 2
		};
		const optimizationLabelStyle = {
			color: TONE.quiet,
			fontSize: 9.5,
			fontWeight: 500
		};
		const optimizationValueStyle = {
			color: TONE.text,
			fontFamily: MONO,
			fontSize: 14,
			fontWeight: 600,
		...
		const warmLabelStyle = {
			color: TONE.quiet,
			fontSize: 10.5
		};
		const warmValueStyle = {
			overflow: "hidden",
			color: TONE.muted,
			fontFamily: MONO,
			fontSize: 10.5,
		...
		/**
		* Context Optimizer locale dictionaries.
		*
		...
		*/
		const NS = "context-optimizer";
		/** English dictionary; the key set every other dictionary mirrors. */
		const en = {
			"cd.title": "Context Optimizer",
			"cd.subtitle": "Context audit and tool optimisation",
			"cd.hint": "Open Context Optimizer",
			...
			"cd.optimization": "Tool surface optimisation",
			"cd.before": "Before",
			"cd.after": "After",
			"cd.savings": "Saved",
			"cd.tier": "Tier {tier}",
		...
		const zh = {
			"cd.title": "Context Optimizer",
			"cd.subtitle": "上下文审计与工具优化",
			"cd.hint": "打开 Context Optimizer",
			"cd.total": "常驻合计",
			"cd.tokens": "token",
		...
		*/
		function apply(ctx) {
			ctx.effect(() => ctx.locale.register(NS, {
				zh,
				en
			}), "context-optimizer: dictionaries");
