 ...
 */
export declare const MANIFEST_CONTEXT = "tool-search:catalog";
/**
 ...
 */
export declare const MANIFEST_HEADER = "Deferred tool catalog \u2014 these tools are NOT directly callable. To use one, call tool_search to find it, tool_describe to load its schema, or tool_call to invoke it. A searched, described, or called tool is injected into your visible tools for later turns.";
