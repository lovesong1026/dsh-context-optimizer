 ...
 */
export declare const NS = "context-optimizer";
/** English dictionary; the key set every other dictionary mirrors. */
declare const en: {
    readonly 'cd.title': "Context Optimizer";
    readonly 'cd.subtitle': "Context audit and tool optimisation";
    readonly 'cd.hint': "Open Context Optimizer";
    ...
    readonly 'cd.optimization': "Tool surface optimisation";
    readonly 'cd.before': "Before";
    readonly 'cd.after': "After";
    readonly 'cd.savings': "Saved";
    readonly 'cd.tier': "Tier {tier}";
    readonly 'cd.warm': "Warm tools";
    readonly 'cd.none': "none";
    readonly 'cd.inactive': "Slimming inactive";
...
declare module '@deepseek-ai/dsh-client-ui-slots' {
    interface LocaleNamespaceMap {
        'context-optimizer': keyof typeof en;
    }
}
